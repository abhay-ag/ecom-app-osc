          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mb-4">
                <h3 className="tracking-widest text-indigo-600 font-medium">
                  {product.category}
                </h3>
              </div>
              ...
              <div className="flex mt-16 flex-row items-center">
                ...
                <div className="flex items-center mx-4 text-2xl">
                  <button
                    onClick={() => {
                      addToCart(slug, 1, product);
                    }}
                    className="flex mx-4 ml-auto text-white bg-indigo-500 border-0 px-4 focus:outline-none hover:bg-indigo-600 rounded"
                  >
                    Add to Cart
                  </button>
                  <button
                    ...
                    className="flex ml-auto text-white bg-indigo-500 border-0 px-4 focus:outline-none hover:bg-indigo-600 rounded"
                  >
                    Checkout
                  </button>
                </div>
