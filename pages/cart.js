          ...
          <div className="w-3/4 bg-white px-10 py-6">
            ...
            {cart.length ? (
              <div className="flex mt-6 mb-5">
                ...
                <h3 className="font-semibold  text-gray-900 text-xs uppercase w-1/5 text-center">
                  Quantity
                </h3>
                <h3 className="font-semibold  text-gray-900 text-xs uppercase w-1/5 text-center">
                  Remove
                  ...
                  <Link href={`/product/${item.slug}`}>
                    <div className="flex w-2/5 cursor-pointer">
                      ...
                      <div className="flex flex-col ml-4 flex-grow">
                        <span className="mt-1 flex justify-between text-base font-medium text-gray-900">
                          {item.name}
                        </span>
                        <span className="text-indigo-600 text-sm mt-4">
                          {item.category}
                        </span>
                      </div>
                    </div>
                  </Link>
                  <div className="flex justify-center w-1/5">{item.qty}</div>
          ...
          <div id="summary" className="w-1/4 px-8 py-10">
            ...
            <div className="border-t mt-8">
              ...
              <button
                ...
                onClick={createUpdateOrderAndCheckout}
                className="disabled:bg-indigo-3 00 bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full"
              >
                Checkout
              </button>
            </div>
