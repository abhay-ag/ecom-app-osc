    ...
    <div className="container m-auto flex flex-col items-center px-4">
      ...
      <div className="flex flex-col items-center">
        ...
        <font className="mt-4 w-[58vw] text-center font-normal">
          ...
          dance, and the mountain always leads. You can't buy happiness, but you
          can buy a ski pass.
        </font>
      </div>
      <button className="bg-indigo-500 rounded px-8 py-2 text-white my-6 text-lg">Shop Now</button>
    </div>
  );
}
